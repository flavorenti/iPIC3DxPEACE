...
#                            Tpar require Tper, Anis, Gyro both require Tpar and Tper
#
# Job 12/2021
#-------------------------------------------------------------------
...
out_tars = ['Eper','Epar','Eprimei','Eprimee','Tiso','Tper','Tpar','Anis','Gyro']
cuts = ['eq','dp']
cycle_min = 0
cycle_max  = 2000000
#=======================================================================================
...
#----compute-derived-fields------------------
      ...
      for tar in out_tars:
        ...
        for sp in alldata.meta['species']:
          ...
          if tar=='Gyro' :
            alldata.data[tar+sp+'%.8i'%int(seg)] = alldata.calc_scalr('TYZ'+sp,'TYZ'+sp,'TXY'+sp,'TXY'+sp,'TXZ'+sp,'TXZ'+sp,seg=seg,fill=False)/alldata.calc_scalr('Tper'+sp,'Tper'+sp,'Tpar'+sp,'Tper'+sp,'Tpar'+sp,'Tper'+sp,seg=seg,fill=False)
