...
def Figure3(Pixx_vtk,Piyy_vtk,Pizz_vtk,Pixy_vtk,Pixz_vtk,Piyz_vtk,Pexx_vtk,Peyy_vtk,Pezz_vtk,Pexy_vtk,Pexz_vtk,Peyz_vtk,Jxi_xz,Jxi_xy,Jyi_xz,Jyi_xy,Jzi_xz,Jzi_xy,Jxe_xz,Jxe_xy,Jye_xz,Jye_xy,Jze_xz,Jze_xy,ni_xz,ni_xy,ne_xz,ne_xy,Ncycle): 
        ...
        add_plot(fig3,221,Pi_xz,x,z,zpl,'x[Rm]','z[Rm]','Pi','copper',0,1e-4,ylab=True)
        add_plot(fig3,222,abs(Pe_xz),x,z,zpl,'x[Rm]','z[Rm]','Pe','copper',0,1e-4,cmap=True)
        add_plot(fig3,223,Pi_xy,x,y,ypl,'x[Rm]','y[Rm]','Pi','copper',0,1e-4,xlab=True,ylab=True)
        add_plot(fig3,224,abs(Pe_xy),x,y,ypl,'x[Rm]','y[Rm]','Pe','copper',0,1e-4,xlab=True)
        plt.savefig('images/Mercury_SaeInit_Fig3-P_PR'+str(PR_number)+'_'+str(Ncycle*dt)+'.png',format='png')
        plt.close()
        ### 3th figure T ###
        fig3 = plt.figure()
        ...
        add_plot(fig3,221,Ti_xz,x,z,zpl,'x[Rm]','z[Rm]','Ti','copper',0,1e-4,ylab=True)
        add_plot(fig3,222,abs(Te_xz),x,z,zpl,'x[Rm]','z[Rm]','Te','copper',0,1e-4,cmap=True)
        add_plot(fig3,223,Ti_xy,x,y,ypl,'x[rm]','y[Rm]','Ti','copper',0,1e-4,xlab=True,ylab=True)
        add_plot(fig3,224,abs(Te_xy),x,y,ypl,'x[Rm]','y[Rm]','Te','copper',0,1e-4,xlab=True)
        plt.savefig('images/Mercury_SaeInit_Fig3-T_PR'+str(PR_number)+'_'+str(Ncycle*dt)+'.png',format='png')
        plt.close()
...
def Figure4(E_vtk,Ncycle):
        ...
        add_plot(fig4,231,Ex_xz,x,z,zpl,'x[Rm]','z[Rm]','Ex','jet',-6e-4,6e-4,ylab=True)
        add_plot(fig4,232,Ey_xz,x,z,zpl,'x[Rm]','z[Rm]','Ey','jet',-6e-4,6e-4,cmap=True)
        add_plot(fig4,233,Ez_xz,x,z,zpl,'x[Rm]','z[Rm]','Ez','jet',-6e-4,6e-4)
        add_plot(fig4,234,Ex_xy,x,y,ypl,'x[Rm]','y[Rm]','Ex','jet',-6e-4,6e-4,xlab=True,ylab=True)
        add_plot(fig4,235,Ey_xy,x,y,ypl,'x[Rm]','y[Rm]','Ey','jet',-6e-4,6e-4,xlab=True)
        add_plot(fig4,236,Ez_xy,x,y,ypl,'x[Rm]','y[Rm]','Ez','jet',-6e-4,6e-4,xlab=True)
...
def Figure5(B_vtk,Ncycle):        
        ...
        add_plot(fig5,231,Bx_xz,x,z,zpl,'x[Rm]','z[Rm]','Bx','jet',-0.03,0.03,ylab=True)
        add_plot(fig5,232,By_xz,x,z,zpl,'x[Rm]','z[Rm]','By','jet',-0.03,0.03,cmap=True)
        add_plot(fig5,233,Bz_xz,x,z,zpl,'x[Rm]','z[Rm]','Bz','jet',-0.03,0.03)
        add_plot(fig5,234,Bx_xy,x,y,ypl,'x[Rm]','y[Rm]','Bx','jet',-0.03,0.03,xlab=True,ylab=True)
        add_plot(fig5,235,By_xy,x,y,ypl,'x[Rm]','y[Rm]','By','jet',-0.03,0.03,xlab=True)
        add_plot(fig5,236,Bz_xy,x,y,ypl,'x[Rm]','y[Rm]','Bz','jet',-0.03,0.03,xlab=True)
...
def Figure6_Ui(Ji,n,Ncycle):
        ...
        Uzi_xz = Ji[4]/n[0]
        Uzi_xy = Ji[5]/n[1]
        add_plot(fig1,231,Uxi_xz,x,z,zpl,'x[Rm]','z[Rm]','Uxi','jet',-0.04,0.04,ylab=True)
        add_plot(fig1,232,Uyi_xz,x,z,zpl,'x[Rm]','z[Rm]','Uyi','jet',-0.04,0.04,cmap=True)
        add_plot(fig1,233,Uzi_xz,x,z,zpl,'x[Rm]','z[Rm]','Uzi','jet',-0.04,0.04)
        add_plot(fig1,234,Uxi_xy,x,y,ypl,'x[Rm]','y[Rm]','Uxi','jet',-0.04,0.04,xlab=True,ylab=True)
        add_plot(fig1,235,Uyi_xy,x,y,ypl,'x[Rm]','y[Rm]','Uyi','jet',-0.04,0.04,xlab=True)
        add_plot(fig1,236,Uzi_xy,x,y,ypl,'x[Rm]','y[Rm]','Uzi','jet',-0.04,0.04,xlab=True)
        plt.savefig('images/Mercury_SaeInit_Fig6-1_PR'+str(PR_number)+'_'+str(Ncycle*dt)+'.png',format='png')
        plt.close()
...
def Figure6_Ue(Je,n,Ncycle):
        ...
        Uze_xz = Je[4]/n[2]
        Uze_xy = Je[5]/n[3]
        add_plot(fig1,231,Uxe_xz,x,z,zpl,'x[Rm]','z[Rm]','Uxe','jet',-0.04,0.04,ylab=True)
        add_plot(fig1,232,Uye_xz,x,z,zpl,'x[Rm]','z[Rm]','Uye','jet',-0.04,0.04,cmap=True)
        add_plot(fig1,233,Uze_xz,x,z,zpl,'x[Rm]','z[Rm]','Uze','jet',-0.04,0.04)
        add_plot(fig1,234,Uxe_xy,x,y,ypl,'x[Rm]','y[Rm]','Uxe','jet',-0.04,0.04,xlab=True,ylab=True)
        add_plot(fig1,235,Uye_xy,x,y,ypl,'x[Rm]','y[Rm]','Uye','jet',-0.04,0.04,xlab=True)
        add_plot(fig1,236,Uze_xy,x,y,ypl,'x[Rm]','y[Rm]','Uze','jet',-0.04,0.04,xlab=True)
        plt.savefig('images/Mercury_SaeInit_Fig6-2_PR'+str(PR_number)+'_'+str(Ncycle*dt)+'.png',format='png')
        plt.close()
...
def Figure7(ni_xz,ni_xy,ne_xz,ne_xy,modB_xz,modB_xy,Ti_xz,Ti_xy,Te_xz,Te_xy,Ncycle):
        ...
        plt.axis('off')
        add_plot(fig1,231,di_xz,x,z,zpl,'x[Rm]','z[Rm]','di/dx','seismic_r',1e-1,1e3,ylab=True,log=True,Mariner=False)
        add_plot(fig1,232,ri_xz,x,z,zpl,'x[Rm]','z[Rm]','ri/dx','seismic_r',1e-1,1e3,cmap=True,log=True,add_profiles=True,Mariner=False)
        add_plot(fig1,233,fpefce_xz,x,z,zpl,'x[Rm]','z[Rm]',r'$f_{pe}/f_{ce}$','seismic_r',1e-1,1e3,log=True,Mariner=False)
        add_plot(fig1,234,di_xy,x,y,ypl,'x[Rm]','y[Rm]','di/dx','seismic_r',1e-1,1e3,xlab=True,ylab=True,log=True,Mariner=False)
        add_plot(fig1,235,ri_xy,x,y,ypl,'x[Rm]','y[Rm]','ri/dx','seismic_r',1e-1,1e3,xlab=True,log=True,Mariner=False)
        add_plot(fig1,236,fpefce_xy,x,y,ypl,'x[Rm]','y[Rm]',r'$f_{pe}/f_{ce}$','seismic_r',1e-1,1e3,xlab=True,log=True,Mariner=False)
        plt.savefig('images/Mercury_SaeInit_Fig7_PR'+str(PR_number)+'_'+str(Ncycle*dt)+'.png',format='png')
        plt.close()
...
def Figure8(Tensi_xz,Tensi_xy,Tense_xz,Tense_xy,Bvers_xz,Bvers_xy,Ncycle):
        ...
        plt.axis('off')
        add_plot(fig1,221,Tpari_xz/Tperi_xz,x,z,zpl,'x[Rm]','z[Rm]',r'','BrBG',1.e-2,1.e2,ylab=True,log=True)
        add_plot(fig1,222,Tpare_xz/Tpere_xz,x,z,zpl,'x[Rm]','z[Rm]',r'','BrBG',1.e-2,1.e2,cmap=True,add_profiles=True,log=True)
        add_plot(fig1,223,Tpari_xy/Tperi_xy,x,y,ypl,'x[Rm]','z[Rm]',r'','BrBG',1.e-2,1.e2,xlab=True,ylab=True,log=True)
        add_plot(fig1,224,Tpare_xy/Tpere_xy,x,y,ypl,'x[Rm]','y[Rm]',r'','BrBG',1.e-2,1.e2,xlab=True,log=True)
        plt.savefig('images/Mercury_SaeInit_Fig8_PR'+str(PR_number)+'_'+str(Ncycle*dt)+'.png',format='png')
        plt.close()
