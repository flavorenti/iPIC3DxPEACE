  ...
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      coprocessor.RegisterView(renderView1,
          filename='image_%t.png', freq=1, fittoscreen=0, magnification=1, width=1214, height=729, cinema={}, compression=-1)
      ...
      exosphere_Tperpare0_0vtk = LegacyVTKReader(FileNames=['/home/lquerci/NICE/build_iPIC3D/data/Exosphere_Tperpare0_0.vtk'])
      ...
      # create a new 'Slice'
      slice2 = Slice(Input=exosphere_Tperpare0_0vtk)
      slice2.SliceType = 'Plane'
      slice2.SliceOffsetValues = [0.0]

      # init the 'Plane' selected for 'SliceType'
      slice2.SliceType.Origin = [3.9999960000000003, 3.9999960000000003, 0.9999975000000001]
