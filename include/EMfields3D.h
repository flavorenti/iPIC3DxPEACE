...
class EMfields3D                // :public Field
{
  public:
    ...
    */
    ...
    /* compute curl(B) in a given point of th grid */   
    double getCurlN2CB_x(int i, int j, int k);
    double getCurlN2CB_y(int i, int j, int k);
    double getCurlN2CB_z(int i, int j, int k);
  ...
  private:
    ...
    array3_double PHI;
    /*! PSI: 3D scalar field used for magnetic field divergence cleaning, defined on central points between nodes */
    array3_double PSI;
